...
class CTFW_Widget_Archives extends CTFW_Widget {
	...
	function __construct() {
		...
		parent::__construct(
			'ctfw-archives',
			_x( 'CT Archives', 'widget', 'onechurch' ),
			array(
				'description' => __( 'Monthly archive for chosen post type', 'onechurch' )
			)
		);
	...
	function ctfw_fields() { // prefix in case WP core adds method with same name
		...
		$fields = array(
			...
			*/
			...
			// Title
			'title' => array(
				'name'				=> _x( 'Title', 'archives widget', 'onechurch' ),
				'after_name'		=> '', // (Optional), (Required), etc.
				'desc'				=> '',
				'type'				=> 'text', // text, textarea, checkbox, radio, select, number, url, image, color
				'checkbox_label'	=> '', //show text after checkbox
				...
				'number_max'		=> '', // highest possible value for number type
				'options'			=> array(), // array of keys/values for radio or select
				'default'			=> _x( 'Archives', 'archives widget title default', 'onechurch' ), // value to pre-populate option with (before first save or on reset)
				'no_empty'			=> false, // if user empties value, force default to be saved instead
				'allow_html'		=> false, // allow HTML to be used in the value (text, textarea)
				'attributes'		=> array(), // attributes to add to input element
				'class'				=> '', // class(es) to add to input
			...
			// Type
			'post_type' => array(
				'name'				=> _x( 'Type', 'archives widget', 'onechurch' ),
				'after_name'		=> '', // (Optional), (Required), etc.
				'desc'				=> '',
			...
			// Limit
			'limit' => array(
				'name'				=> _x( 'Limit', 'archives widget', 'onechurch' ),
				'after_name'		=> '', // (Optional), (Required), etc.
				'desc'				=> _x( 'Set to 0 for no limit.', 'archives widget', 'onechurch' ),
			...
			'show_count' => array(
				...
				'number_min'		=> '', // lowest possible value for number type
				'number_max'		=> '', // highest possible value for number type
				'checkbox_label'	=> _x( 'Show counts', 'archives widget', 'onechurch' ), //show text after checkbox
				'options'			=> array(), // array of keys/values for radio or select
			...
			'show_dropdown' => array(
				...
				'desc'				=> '',
				'type'				=> 'checkbox', // text, textarea, checkbox, radio, select, number, url, image, color
				'checkbox_label'	=> _x( 'Show as dropdown', 'archives widget', 'onechurch' ), //show text after checkbox
				'radio_inline'		=> false, // show radio inputs inline or on top of each other
				'number_min'		=> '', // lowest possible value for number type
				'number_max'		=> '', // highest possible value for number type
				'options'			=> array(), // array of keys/values for radio or select
	...
	function ctfw_post_type_options() {
		...
		$options = array_merge(
			array(
				'post' => _x( 'Blog', 'archives widget', 'onechurch' )
			),
			$options
		);
