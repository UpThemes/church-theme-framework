...
class CTFW_Widget_Slide extends CTFW_Widget {
	...
	function __construct() {
		...
		parent::__construct(
			'ctfw-slide',
			_x( 'CT Slide', 'widget', 'onechurch' ),
			array(
				'description' => __( 'A slide to be shown in a slider', 'onechurch' )
			)
		);
	...
	function ctfw_fields() { // prefix in case WP core adds method with same name
		...
		$fields = array(
			...
			*/
			...
			// Title
			'title' => array(
				'name'				=> _x( 'Title', 'slide widget', 'onechurch' ),
				'after_name'		=> '', // (Optional), (Required), etc.
				'desc'				=> '',
				'type'				=> 'text', // text, textarea, checkbox, radio, select, number, url, image, color
				'checkbox_label'	=> '', //show text after checkbox
			...
			// Description
			'description' => array(
				'name'				=> _x( 'Description', 'slide widget', 'onechurch' ),
				'after_name'		=> '', // (Optional), (Required), etc.
				'desc'				=> '',
				'type'				=> 'text', // text, textarea, checkbox, radio, select, number, url, image, color
				'checkbox_label'	=> '', //show text after checkbox
			...
			// Click URL
			'click_url' => array(
				'name'				=> _x( 'Click URL', 'slide widget', 'onechurch' ),
				'after_name'		=> '', // (Optional), (Required), etc.
				'desc'				=> '',
			...
			'click_new' => array(
				...
				'checkbox_label'	=> _x( 'Open in new tab', 'slide widget', 'onechurch' ), //show text after checkbox
				'radio_inline'		=> false, // show radio inputs inline or on top of each other
				'number_min'		=> '', // lowest possible value for number type
				'number_max'		=> '', // highest possible value for number type
				'options'			=> array(), // array of keys/values for radio or select
			...
			// Image
			'image_id' => array(
				'name'				=> _x( 'Image', 'slide widget', 'onechurch' ),
				'after_name'		=> '', // (Optional), (Required), etc.
				'desc'				=> '',
			...
			'video' => array(		// generic "video" (vs "video_url") in case ever want to allow embed code
				'name'				=> _x( 'Video URL', 'slide widget', 'onechurch' ),
				'after_name'		=> '', // (Optional), (Required), etc.
				'desc'				=> '',
				'type'				=> 'url', // text, textarea, checkbox, radio, select, number, url, image, color
				'checkbox_label'	=> '', //show text after checkbox
